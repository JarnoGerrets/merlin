...
public sealed class SpokenCommandNormalizerTests
{
    ...
    [InlineData("Hey Merlin, open your eyes", UiControlModeCommandAction.Start)]
    [InlineData("Hey Merlin, eyes open", UiControlModeCommandAction.Start)]
    [InlineData("please open your eyes", UiControlModeCommandAction.Start)]
    [InlineData("please eyes open", UiControlModeCommandAction.Start)]
    [InlineData("can you open your eyes please", UiControlModeCommandAction.Start)]
    [InlineData("calibrate pinch", UiControlModeCommandAction.CalibratePinch)]
    [InlineData("Hey Merlin, calibrate pinch", UiControlModeCommandAction.CalibratePinch)]
    [InlineData("open your eyes calibrate pinch", UiControlModeCommandAction.CalibratePinch)]
    [InlineData("eyes open callibrate pinch", UiControlModeCommandAction.CalibratePinch)]
    [InlineData("calibrate motion region", UiControlModeCommandAction.CalibrateMotionRegion)]
    [InlineData("Hey Merlin, calibrate control region", UiControlModeCommandAction.CalibrateMotionRegion)]
    [InlineData("calibrate pointer region", UiControlModeCommandAction.CalibrateMotionRegion)]
    [InlineData("callibrate reachable region", UiControlModeCommandAction.CalibrateMotionRegion)]
    ...
    [InlineData("Hey Merlin, close your eyes", UiControlModeCommandAction.Stop)]
    [InlineData("Hey Merlin, eyes closed", UiControlModeCommandAction.Stop)]
    [InlineData("please close your eyes", UiControlModeCommandAction.Stop)]
    [InlineData("please eyes closed", UiControlModeCommandAction.Stop)]
    [InlineData("can you close your eyes please", UiControlModeCommandAction.Stop)]
