...
# BrowserPinchClickControllerTests

## File

`Merlin.Backend.Tests/BrowserPinchClickControllerTests.cs`

Verified present in current repo.

## Purpose

Regression test atlas for `BrowserPinchClickControllerTests`.
...
| --- | --- | --- |
| `BrowserPinchClickControllerTests.cs` | This is the test file. | May not cover live devices or UI. |
...
Before changing `BrowserPinchClickControllerTests`, read the linked feature note, architecture note, flow note, and bug index entry for the affected system.
