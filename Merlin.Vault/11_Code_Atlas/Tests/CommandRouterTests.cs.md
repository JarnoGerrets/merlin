...
Regression test atlas for `CommandRouterTests`.
...
| --- | --- | --- |
| `CommandRouterTests.cs` | This is the test file. | May not cover live devices or UI. |
...
Before changing `CommandRouterTests`, read the linked feature note, architecture note, flow note, and bug index entry for the affected system.
