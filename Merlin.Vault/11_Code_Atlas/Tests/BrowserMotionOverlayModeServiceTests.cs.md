...
# BrowserMotionOverlayModeServiceTests

## File

`Merlin.Backend.Tests/BrowserMotionOverlayModeServiceTests.cs`

Verified present in current repo.

## Purpose

Regression test atlas for `BrowserMotionOverlayModeServiceTests`.
...
| --- | --- | --- |
| `BrowserMotionOverlayModeServiceTests.cs` | This is the test file. | May not cover live devices or UI. |
...
Before changing `BrowserMotionOverlayModeServiceTests`, read the linked feature note, architecture note, flow note, and bug index entry for the affected system.
