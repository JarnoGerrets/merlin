...
Regression test atlas for `MotionControlModeServiceTests`.
...
| --- | --- | --- |
| `MotionControlModeServiceTests.cs` | This is the test file. | May not cover live devices or UI. |
...
Before changing `MotionControlModeServiceTests`, read the linked feature note, architecture note, flow note, and bug index entry for the affected system.
