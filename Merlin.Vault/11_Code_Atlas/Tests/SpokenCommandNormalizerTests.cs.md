...
# SpokenCommandNormalizerTests

## File

`Merlin.Backend.Tests/SpokenCommandNormalizerTests.cs`

Verified present in current repo.

## Purpose

Regression test atlas for `SpokenCommandNormalizerTests`.
...
| --- | --- | --- |
| `SpokenCommandNormalizerTests.cs` | This is the test file. | May not cover live devices or UI. |
...
Before changing `SpokenCommandNormalizerTests`, read the linked feature note, architecture note, flow note, and bug index entry for the affected system.
