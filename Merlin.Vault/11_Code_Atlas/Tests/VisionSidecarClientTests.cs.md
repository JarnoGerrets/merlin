...
# VisionSidecarClientTests

## File

`Merlin.Backend.Tests/VisionSidecarClientTests.cs`

Verified present in current repo.

## Purpose

Regression test atlas for `VisionSidecarClientTests`.
...
| --- | --- | --- |
| `VisionSidecarClientTests.cs` | This is the test file. | May not cover live devices or UI. |
...
Before changing `VisionSidecarClientTests`, read the linked feature note, architecture note, flow note, and bug index entry for the affected system.
