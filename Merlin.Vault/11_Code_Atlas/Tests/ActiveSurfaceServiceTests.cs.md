...
# ActiveSurfaceServiceTests

## File

`Merlin.Backend.Tests/ActiveSurfaceServiceTests.cs`

Verified present in current repo.

## Purpose

Regression test atlas for `ActiveSurfaceServiceTests`.
...
| --- | --- | --- |
| `ActiveSurfaceServiceTests.cs` | This is the test file. | May not cover live devices or UI. |
...
Before changing `ActiveSurfaceServiceTests`, read the linked feature note, architecture note, flow note, and bug index entry for the affected system.
