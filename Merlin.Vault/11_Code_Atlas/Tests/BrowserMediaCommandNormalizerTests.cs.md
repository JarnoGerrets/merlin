...
`Merlin.Backend.Tests/BrowserMediaCommandNormalizerTests.cs`

Verified present in current repo.

## Purpose

Regression test atlas for `BrowserMediaCommandNormalizerTests`.
...
| --- | --- | --- |
| `BrowserMediaCommandNormalizerTests.cs` | This is the test file. | May not cover live devices or UI. |
...
Before changing `BrowserMediaCommandNormalizerTests`, read the linked feature note, architecture note, flow note, and bug index entry for the affected system.
