...
# VisionGestureEventRouterTests

## File

`Merlin.Backend.Tests/VisionGestureEventRouterTests.cs`

Verified present in current repo.

## Purpose

Regression test atlas for `VisionGestureEventRouterTests`.
...
| --- | --- | --- |
| `VisionGestureEventRouterTests.cs` | This is the test file. | May not cover live devices or UI. |
...
Before changing `VisionGestureEventRouterTests`, read the linked feature note, architecture note, flow note, and bug index entry for the affected system.
