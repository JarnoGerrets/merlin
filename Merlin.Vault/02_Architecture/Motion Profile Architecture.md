...
MotionControlModeService resolves and activates IMotionControlProfile implementations by active surface.
...
| --- | --- | --- |
| Mode service | `MotionControlModeService.cs` | Enabled/profile state and sidecar tracking ownership. |
| Registry | `MotionControlProfileRegistry.cs` | Profile resolution. |
| Profiles | `Profiles/*.cs` | Dashboard, BrowserWorkspace, Neutral behavior. |
