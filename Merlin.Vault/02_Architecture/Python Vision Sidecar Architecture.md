...
Python worker owns camera capture, MediaPipe hand detection, pointer mapping, pinch detection, and calibration.
...
| --- | --- | --- |
| Worker | `Merlin.Backend/VisionScripts/vision_worker.py` | Camera, MediaPipe, pointer, pinch, calibration. |
| Host | `VisionSidecarHost.cs` | Process owner and stdout parser. |
| Client | `VisionSidecarClient.cs` | Protocol client wrapper. |
