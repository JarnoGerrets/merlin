...
prompt_id: PROMPT-2026-07-07-019
derived_work_id:
status: draft
related_plan: PLAN-2026-07-07-019
related_plan_path: Merlin.Vault/13_Implementation_Plans/Architecture_Refactor/PLAN-2026-07-07-019 Browser Module Migration Plan.md
origin_run:
task_mode: refactor
tags:
  - merlin
...
# PROMPT-2026-07-07-019 Implement Browser Module Migration
...
Implement:
Merlin.Vault/13_Implementation_Plans/Architecture_Refactor/PLAN-2026-07-07-019 Browser Module Migration Plan.md
...
High risk. Do not use until surface registry and adapter boundaries are implemented.
