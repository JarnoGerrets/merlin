...
prompt_id: PROMPT-2026-07-07-015
derived_work_id:
status: draft
related_plan: PLAN-2026-07-07-015
related_plan_path: Merlin.Vault/13_Implementation_Plans/Architecture_Refactor/PLAN-2026-07-07-015 Capability Routing And Module Registration Plan.md
origin_run:
task_mode: refactor
tags:
  - merlin
...
# PROMPT-2026-07-07-015 Implement Capability Routing And Module Registration
...
Implement:
Merlin.Vault/13_Implementation_Plans/Architecture_Refactor/PLAN-2026-07-07-015 Capability Routing And Module Registration Plan.md
...
Do not use until previous plans are implemented.
