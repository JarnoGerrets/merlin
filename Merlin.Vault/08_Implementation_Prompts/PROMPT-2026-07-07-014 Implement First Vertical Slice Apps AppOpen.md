...
prompt_id: PROMPT-2026-07-07-014
derived_work_id:
status: ready
related_plan: PLAN-2026-07-07-014
related_plan_path: Merlin.Vault/13_Implementation_Plans/Architecture_Refactor/PLAN-2026-07-07-014 First Vertical Slice Apps AppOpen Plan.md
origin_run:
task_mode: refactor
tags:
  - merlin
...
# PROMPT-2026-07-07-014 Implement First Vertical Slice Apps AppOpen
...
Implement:
Merlin.Vault/13_Implementation_Plans/Architecture_Refactor/PLAN-2026-07-07-014 First Vertical Slice Apps AppOpen Plan.md
...
Full plan. Only `app.open` may be handled by Next, and only when enabled by config.
