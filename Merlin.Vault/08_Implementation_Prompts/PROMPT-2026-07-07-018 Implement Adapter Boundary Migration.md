...
prompt_id: PROMPT-2026-07-07-018
derived_work_id:
status: draft
related_plan: PLAN-2026-07-07-018
related_plan_path: Merlin.Vault/13_Implementation_Plans/Architecture_Refactor/PLAN-2026-07-07-018 Adapter Boundary Migration Plan.md
origin_run:
task_mode: refactor
tags:
  - merlin
...
# PROMPT-2026-07-07-018 Implement Adapter Boundary Migration
...
Implement:
Merlin.Vault/13_Implementation_Plans/Architecture_Refactor/PLAN-2026-07-07-018 Adapter Boundary Migration Plan.md
...
Do not use until kernel/module seams are stable.
