...
created_prompt: PROMPT-2026-07-07-016
implemented_by:
superseded_by:
---

# PLAN-2026-07-07-016 Dynamic Surface Registry Plan
...
Related feature: Dynamic Surface Registry
...
Replace static surface assumptions with registered surface descriptors and capabilities.

## Scope

Introduce `ISurfaceRegistry`, `ISurfaceProvider`, dynamic surface IDs, capability sets, and migration wrappers for dashboard/browser surfaces.
