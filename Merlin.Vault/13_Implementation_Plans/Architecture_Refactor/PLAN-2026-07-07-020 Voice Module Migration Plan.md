...
created_prompt: PROMPT-2026-07-07-020
implemented_by:
superseded_by:
---

# PLAN-2026-07-07-020 Voice Module Migration Plan
...
Move voice playback/STT/TTS/barge-in/interruption into Voice module late and safely.

## Scope

Wrap existing voice services first, then migrate state ownership, playback output, barge-in/interruption ownership, and diagnostics.
