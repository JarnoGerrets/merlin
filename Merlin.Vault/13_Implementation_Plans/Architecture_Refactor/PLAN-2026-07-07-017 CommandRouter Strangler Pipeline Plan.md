...
created_prompt: PROMPT-2026-07-07-017
implemented_by:
superseded_by:
---

# PLAN-2026-07-07-017 CommandRouter Strangler Pipeline Plan
...
Related feature: CommandRouter Strangler
...
Turn `CommandRouter` into a facade over named pipeline stages while preserving behavior.

## Scope

Extract normalization, pending operation check, routing, safety, execution, response presentation, progress feedback, and legacy fallback stages.
