...
created_prompt: PROMPT-2026-07-07-019
implemented_by:
superseded_by:
---

# PLAN-2026-07-07-019 Browser Module Migration Plan
...
Related feature: Browser Module
...
Move BrowserWorkspace behavior into Browser module after surfaces and adapter boundaries exist.

## Scope

Migrate browser capabilities, BrowserHost client, page snapshot, page actions, media controls, browser surface provider, safety policies, and site profile seams.
