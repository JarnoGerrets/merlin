...
created_prompt: PROMPT-2026-07-07-018
implemented_by:
superseded_by:
---

# PLAN-2026-07-07-018 Adapter Boundary Migration Plan
...
Related feature: Adapter Boundaries
...
Wrap external integrations behind ports/adapters before module migration.

## Scope

Create ports for model providers, BrowserHost IPC, Godot/WebSocket output, audio/STT/TTS, vision sidecar, and web search provider.
