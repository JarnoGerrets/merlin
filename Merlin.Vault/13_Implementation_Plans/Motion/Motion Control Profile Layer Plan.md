...
source_path: Merlin.ToDo/motion_control/merlin_motion_control_profile_layer_implementation_plan.md
related_features:
  - Motion Control
...
Related feature: [[Motion Control]], [[Motion Control Profile Layer]], [[Control Profile DB]]
Related architecture: [[Motion Architecture]]
Related code atlas: [[MotionControlModeService]]
Original source: `Merlin.ToDo/motion_control/merlin_motion_control_profile_layer_implementation_plan.md`
